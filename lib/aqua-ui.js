...
` + a[c].replace(" at new ", " at ");
                    return e.displayName && O.includes("<anonymous>") && (O = O.replace("<anonymous>", e.displayName)), typeof e == "function" && oe.set(e, O), O;
                  }
                while (c >= 1 && v >= 0);
              break;
            }
    ...
    var X = Object.prototype.hasOwnProperty, Te = {}, je = S.ReactDebugCurrentFrame;
    function se(e) {
      if (e) {
    ...
    function or(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (Se(t), a = "" + t), er(r) && (Se(r.key), a = "" + r.key), Qe(r) && (b = r.ref, rr(r, i));
        for (s in r)
...
function Le(u) {
  var l = u.children, f = u.position, p = f === void 0 ? "fixed" : f, R = u.originalPosition, m = R === void 0 ? { left: 0, top: 0 } : R, T = u.style, h = T === void 0 ? {} : T, d = gr(), C = K(m.left), g = C[0], j = C[1], w = K(m.top), q = w[0], N = w[1], Z = K(!1), Q = Z[0], S = Z[1], _ = K(0), ee = _[0], k = _[1], re = K(0), te = re[0], A = re[1];
  if (p === "fixed") {
    var L = function(y) {
      S(!0), k(y.pageX), A(y.pageY);
    }, M = function(y) {
      if (Q) {
...
const Or = "AqModalDialog-module__aq_modal_dialog_layer___aj202", Sr = "AqModalDialog-module__aq_modal_dialog___GRSj2", We = {
  aq_modal_dialog_layer: Or,
  aq_modal_dialog: Sr
};
function Dr(u) {
